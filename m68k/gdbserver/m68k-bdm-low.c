 ...
 */
static const int m68k_bdm_reg_sizes[4] = { 32, 32, 32, 96 };
...
static struct m68k_bdm_reg_mapping m68k_bdm_cfv4e_reg_map[] = {
  ...
  { "fp7",       M68K_BDM_REG_TYPE_M68881_EXT,    24, BDM_REG_CTRL (0x81c) },
  { "fpiaddr",   M68K_BDM_REG_TYPE_INT32,         25, BDM_REG_CTRL (0x821) },
  { "fpstatus",  M68K_BDM_REG_TYPE_INT32,         26, BDM_REG_CTRL (0x822) },
  { "fpcontrol", M68K_BDM_REG_TYPE_INT32,         27, BDM_REG_CTRL (0x824) },
  { "vbr",       M68K_BDM_REG_TYPE_VOID_DATA_PTR, 28, BDM_REG_CTRL (0x801) },
  { "cacr",      M68K_BDM_REG_TYPE_INT32,         29, BDM_REG_CTRL (0x002) },
  { "asid",      M68K_BDM_REG_TYPE_INT32,         30, BDM_REG_CTRL (0x003) },
  { "acr0",      M68K_BDM_REG_TYPE_INT32,         31, BDM_REG_CTRL (0x004) },
  { "acr1",      M68K_BDM_REG_TYPE_INT32,         32, BDM_REG_CTRL (0x005) },
  { "acr2",      M68K_BDM_REG_TYPE_INT32,         33, BDM_REG_CTRL (0x006) },
  { "acr3",      M68K_BDM_REG_TYPE_INT32,         34, BDM_REG_CTRL (0x007) },
  { "mmubar",    M68K_BDM_REG_TYPE_INT32,         35, BDM_REG_CTRL (0x008) },
  { "mbar",      M68K_BDM_REG_TYPE_INT32,         36, BDM_REG_CTRL (0xc0f) },
  { "rambar0",   M68K_BDM_REG_TYPE_INT32,         37, BDM_REG_CTRL (0xc04) },
  { "rambar1",   M68K_BDM_REG_TYPE_INT32,         38, BDM_REG_CTRL (0xc05) },
  { "csr",       M68K_BDM_REG_TYPE_INT32,         39, BDM_REG_DEBUG (0x0) },
  { "aatr",      M68K_BDM_REG_TYPE_INT32,         40, BDM_REG_DEBUG (0x6) },
  { "tdr",       M68K_BDM_REG_TYPE_INT32,         41, BDM_REG_DEBUG (0x7) },
  { "pbr",       M68K_BDM_REG_TYPE_INT32,         42, BDM_REG_DEBUG (0x8) },
  { "pbmr",      M68K_BDM_REG_TYPE_INT32,         43, BDM_REG_DEBUG (0x9) },
  { "abhr",      M68K_BDM_REG_TYPE_INT32,         44, BDM_REG_DEBUG (0xc) },
  { "ablr",      M68K_BDM_REG_TYPE_INT32,         45, BDM_REG_DEBUG (0xd) },
  { "dbr",       M68K_BDM_REG_TYPE_INT32,         46, BDM_REG_DEBUG (0xe) },
  { "dbmr",      M68K_BDM_REG_TYPE_INT32,         47, BDM_REG_DEBUG (0xf) },
  { "macsr",     M68K_BDM_REG_TYPE_INT32,         48, BDM_REG_CTRL (0x804) },
  { "mask",      M68K_BDM_REG_TYPE_INT32,         49, BDM_REG_CTRL (0x805) },
  { "acc0",      M68K_BDM_REG_TYPE_INT32,         50, BDM_REG_CTRL (0x806) },
  { "acc1",      M68K_BDM_REG_TYPE_INT32,         51, BDM_REG_CTRL (0x809) },
  { "acc2",      M68K_BDM_REG_TYPE_INT32,         52, BDM_REG_CTRL (0x80a) },
  { "acc3",      M68K_BDM_REG_TYPE_INT32,         53, BDM_REG_CTRL (0x80b) },
  { "accext01",  M68K_BDM_REG_TYPE_INT32,         54, BDM_REG_CTRL (0x807) },
  { "accext32",  M68K_BDM_REG_TYPE_INT32,         55, BDM_REG_CTRL (0x808) }
};
